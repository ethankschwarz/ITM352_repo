...
//Calculate extended prices for each item using loop and increment subtotal as it goes
let extendedPrices= [];
let subotal=0;
...
//assumes there are no errors or logic requirements on the display of data... which will not me treated
for (let i =0; i < itemData.length; i++) {
