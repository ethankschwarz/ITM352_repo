...
app.get("/login", function (request, response) {
    // Give a simple login form, sticky login form, login error
    let usernameValue = request.query.username || ''; // Retrieve username from query string
    let passwordValue = request.query.password || ''; // Retrieve password from query string
    let error = request.query.error || ''; // Retrieve error from query string
...
<input type="submit" value="Submit" id="submit">
 ...
 app.post("/register", function (request, response) {
    // processes a simple register form on the site
